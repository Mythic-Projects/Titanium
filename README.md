...
Titanium is [Paper](https://github.com/PaperMC/Paper) fork which aims to be fast, fix exploits and bugs, improve API, and provide better configuration for server administrators. 
